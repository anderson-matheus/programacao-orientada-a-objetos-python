...
class TestConverteNumeroRomano(unittest.TestCase):
    def setUp(self):
        ...
        '''
        print('Construir o objeto da class ConverteNumeroRomano')
        self.cnr = ConverteNumeroRomano()

    def tearDown(self):
        '''
        Este método é executado depois que cada test termina
        '''
        print('Destruir o objeto criado')
        self.cnr = None

    # @unittest.skip('Testando skip')
    @unittest.skipIf(sys.version_info > (2, 7),
                     'Não suporta versões superiores a 2.7')
    def test_mil(self):
